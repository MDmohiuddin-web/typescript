...
interface parson{name:string}

// Example usage with custom person interface type
console.log(createArray<parson>({name:"sachin"}))
...
interface parsons{name:string}
interface parsons2{country:string}

// Example usage with custom person and country interface types
console.log(createArrayTopple<parsons,parsons2>({name:"sachin"}, {country:"india"}))
