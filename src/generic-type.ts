...
// const relationWithSalary: genericTuple<object, string> = [ //we never use this type
const relationWithSalary: genericTuple<{name:string,age:number}, string> = [ //we  use this type
  {
    name: "john",
    age: 25,
  },
...
const rollNumberArray3: genericArray<string> = [
  "1",
  "2",
  "3",
  "4",
...
const rollNumberArray5: genericArray<string | number> = [
  1,
  2,
  3,
  4,
...
const rollNumberArray6: genericArray<string | number | boolean> = [
  1,
  2,
  3,
  4,
...
const rollNumberArray7: genericArray<namRolls> = [
  { names: "sachin", rolls: 1 },
  { names: "sachin", rolls: 2 },
];
